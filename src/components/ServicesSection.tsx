...
const services = [
  {
    icon: <FaBell className="w-8 h-8 text-orange-400" />,
  ...
  {
    icon: <FaChartPie className="w-8 h-8 text-orange-400" />,
  ...
  {
    icon: <FaBalanceScale className="w-8 h-8 text-orange-400" />,
  ...
  {
    icon: <FaGraduationCap className="w-8 h-8 text-orange-400" />,
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {services.map((service, idx) => (
          <div
            key={service.title}
            className="bg-[#2d2d2d] p-8 rounded-xl transition duration-300 hover:-translate-y-2 hover:shadow-lg card-hover group"
          >
            <div className="bg-gray-800 w-16 h-16 rounded-full flex items-center justify-center mb-6 mx-auto">
              {service.icon}
            </div>
            <div className="h-0.5 w-0 group-hover:w-full bg-orange-400 transition-all duration-300 mx-auto mb-6 rounded-full" />
            <h3 className="text-xl font-semibold text-white mb-3 text-center">
              {service.title}
            </h3>
            <p className="text-orange-100 text-center">{service.desc}</p>
          </div>
        ))}
      </div>
    </div>
