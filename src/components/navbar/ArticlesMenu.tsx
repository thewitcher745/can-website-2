...
const ArticlesMenuItems = ({ isMobile }) => {
  return (
    <>
      <Link
        href="/news"
...
const MobileArticlesMenu = ({ articlesMenuOpen }) => {
  return (
    <div
...
const DesktopArticlesMenu = ({ articlesMenuOpen }) => {
  return (
    <div
...
export const ArticlesMenuButton = ({ isMobile }) => {
